...
import { registerUser, checkUsername, checkEmail, verifyRegistration } from '../../services/auth'; // Añadir verifyRegistration
...
const Registro = () => {
    ...
    const [otp, setOtp] = useState(''); // Nuevo estado para el código OTP
